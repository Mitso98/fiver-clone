...
const Footer = () => {
  ...
  const btnHandler = (event) => {
    ...
    event.target.id === "currency-btn-id" && setCurrency(true);
    setActive(true);
  };
  ...
  useEffect(() => {
    const activeHandler = (event) => {
      if (
        event.target.id !== "language-btn-id" &&
        event.target.id !== "currency-btn-id"
      ) {
        setActive(false);
        setCurrency(false);
      }
  ...
  return (
    <div className="footer">
      {active && (
        <Overlay
          cur={currency}
          title={currency ? "Choose a currency" : "Choose a language"}
          options={
            currency
              ? [
                  { title: "United States Dollar", subtitle: "USD - $" },

                  { title: "Euro", subtitle: "EUR - €" },
                  { title: "British Pound", subtitle: "GBP - £" },
                  { title: "Australian Dollar", subtitle: "AUD - A$" },
                  { title: "Brazilian Real", subtitle: "BRL - R$" },
                  { title: "Hong Kong Dollar", subtitle: "HKD - HK$" },
                  { title: "Swedish Krona", subtitle: "SEK - SEK" },
                  { title: "New Zealand Dollar", subtitle: "NZD - NZ$" },
                ]
              : [
                  { title: "English" },
                  { title: "Deutsch" },
      ...
      <div className="container">
        ...
        <div className="col">
          <div>
            <h3 className="title"> Support and Education</h3>
          </div>
          <div>
            <p>Help & Support</p>
          </div>
        ...
        <div className="col">
          <div>
            <h3 className="title">Business Solutions</h3>
          </div>
          <div>
      ...
      <div className="down-side">
        <div className="left">
          <div className="title">
            <span className="word">fiverr</span>
            <span className="mark">&reg;</span>
          </div>
          <div className="statement">
            <span className="mark">&copy;</span>
        ...
        <div className="right">
          ...
          <div className="buttons">
            <button onClick={(event) => btnHandler(event)} id="language-btn-id">
              <span id="language-btn-id">
                <svg
                  id="language-btn-id"
                  width="18"
                  height="18"
              ...
              <span id="language-btn-id">English</span>
            </button>

            <button id="currency-btn-id" onClick={(event) => btnHandler(event)}>
              <span id="currency-btn-id">$ USD</span>
            </button>
